...
class UNet_Pytorch_DeepSup_Regression(torch.nn.Module):
    def __init__(self, n_input_channels=3, n_classes=7, n_filt=64, batchnorm=False, dropout=False):
        ...
        self.output_2_up = nn.Upsample(scale_factor=2, mode='nearest')  # does only upscale width and height
        ...
        self.output_3_up = nn.Upsample(scale_factor=2, mode='nearest')  # does only upscale width and height
