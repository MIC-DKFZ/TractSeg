...
class Trainer:
    ...
    def train(self, Config):
        ...
        for epoch_nr in range(Config.NUM_EPOCHS):
            ...
            for type in ["train", "test", "validate"]:
                ...
                batch_generator = self.dataManager.get_batches(batch_size=Config.BATCH_SIZE,
                                                               type=type, subjects=getattr(Config, type.upper() + "_SUBJECTS"))
                ...
                nr_batches = int(nr_of_samples / Config.BATCH_SIZE)
    ...
    def get_seg_single_img(self, Config, probs=False, scale_to_world_shape=True, only_prediction=False):
        '''
